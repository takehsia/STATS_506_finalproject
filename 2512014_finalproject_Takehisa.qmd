...
execute:
  ...
  message: false
---
Github repository:https://github.com/takehsia/STATS_506_finalproject.git
...
## Literature Review
Existing literature emphasizes the potential of Open Government Data (OGD). Janssen et al. (2012) argue that OGD creates value by improving transparency and stimulating innovation. Ubaldi (2013) highlights the need for empirical frameworks to measure these impacts beyond qualitative case studies. This paper contributes to the literature by applying a production function estimation using panel data from 50 U.S. states (2010–2022).
